    ...
    class Bluetooth(App):
        ...
        def print_payslip(self):
            try:
                ...
                self.text("   18:20:53 05/04/16 CEST       ")
                self.text("                                ")
                self.text("                                ")
                self.text("Anz  Beschreibung      Betrag   ")
                self.text("                                ")
                self.text("1  200018 Cosy-Loop    55.00 CHF")
                self.text("1  200018 Cosy-Loop    55.00 CHF")
                self.text("1  200018 Cosy-Loop    55.00 CHF")
                self.text("1  200018 Cosy-Loop    55.00 CHF")
                self.text("1  200018 Cosy-Loop    55.00 CHF")
                self.text("--------------------------------")
                self.text("Total:                275.00 CHF")
                self.text("                                ")
                self.text("                                ")
